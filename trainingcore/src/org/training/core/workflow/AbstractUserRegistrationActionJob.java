...
public abstract class AbstractUserRegistrationActionJob implements AutomatedWorkflowTemplateJob {

    @Autowired
    private ModelService modelService;

    protected CustomerModel getAttachedUser(final WorkflowActionModel action) {
