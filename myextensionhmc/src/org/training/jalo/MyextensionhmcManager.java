...
/**
 * This is the extension manager of the Myextensionhmc extension.
 */
public class MyextensionhmcManager extends GeneratedMyextensionhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MyextensionhmcManager.class);
	 ...
	 */
	public static MyextensionhmcManager getInstance()
	{
		return (MyextensionhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyextensionhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyextensionhmcManager() // NOPMD 
	{
		LOG.debug("constructor of MyextensionhmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MyextensionhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MyextensionhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
