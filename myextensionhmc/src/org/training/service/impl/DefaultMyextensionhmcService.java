...
public class DefaultMyextensionhmcService implements MyextensionhmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMyextensionhmcService.class);
	...
	{
		return DefaultMyextensionhmcService.class.getResourceAsStream("/myextensionhmc/sap-hybris-platform.png");
	}
